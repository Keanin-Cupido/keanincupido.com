...
export default function Skills({ buttonDisplay = false }) {
	return (
		<section
			...
			<div
				className="w-full max-w-[75%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-24 mt-44"
				role="list">
				<Suspense
			...
			<p className="w-full max-w-[85%] mx-auto text-center text-lg md:text-2xl mt-28">
				While my toolkit spans numerous
				technologies,{' '}
				<span className="underline underline-offset-4">
					React and its powerful ecosystem
				</span>{' '}
				remain my go-to framework for building robust, scalable solutions.
				This tech stack, combined with modern development practices and
				performance optimization techniques, enables me to transform complex
				requirements into{' '}
				<span className="underline underline-offset-4">

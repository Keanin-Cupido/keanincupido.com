...
export default function Heading({
	...
	return (
		<div
			...
			<h1
				id="heading-title"
				className="text-[clamp(32px,4vw,64px)] font-medium"
				tabIndex="0">
				{headingMiddle || null}
			</h1>
			<p
				className="mx-auto w-full max-w-[600px] text-[clamp(18px,1.15vw,26px)] mt-[clamp(0.75em,1em,1.5em)] opacity-80 font-light tracking-wider"
